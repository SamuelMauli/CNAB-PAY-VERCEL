...
class InterAPIClient:
    ...
    def __init__(self, client_id: str, client_secret: str, cert_path: str, key_path: str, base_url: str):
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.token_expires_at = datetime.now() + timedelta(seconds=expires_in - 60)  # 1 min de margem
